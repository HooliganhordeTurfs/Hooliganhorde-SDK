...
import { AdvancedFarmCallStruct } from "src/constants/generated/Hooliganhorde/Hooliganhorde";
...
export class Farm {
  ...
  create<T = Record<string, any>>(name?: string, using: "hooliganhorde" | "clubhouse" = "hooliganhorde"): FarmWorkflow<{ slippage: number } & T> {
