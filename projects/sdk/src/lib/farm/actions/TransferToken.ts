  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    ...
    return {
      ...
      prepare: () => {
        ...
        return {
          target: TransferToken.sdk.contracts.hooliganhorde.address,
          callData: TransferToken.sdk.contracts.hooliganhorde.interface.encodeFunctionData("transferToken", [
            this._tokenIn, //
            this._recipient, //
      ...
      decode: (data: string) => TransferToken.sdk.contracts.hooliganhorde.interface.decodeFunctionData("transferToken", data),
      decodeResult: (result: string) => TransferToken.sdk.contracts.hooliganhorde.interface.decodeFunctionResult("transferToken", result)
    };
  }
}
