  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    ...
    return {
      ...
      prepare: () => {
        ...
        return {
          target: ExchangeUnderlying.sdk.contracts.hooliganhorde.address,
          callData: ExchangeUnderlying.sdk.contracts.hooliganhorde.interface.encodeFunctionData("exchangeUnderlying", [
            this.pool,
            tokenIn.address,
            tokenOut.address,
            _amountInStep,
      ...
      decode: (data: string) => ExchangeUnderlying.sdk.contracts.hooliganhorde.interface.decodeFunctionData("exchangeUnderlying", data),
      decodeResult: (result: string) =>
        ExchangeUnderlying.sdk.contracts.hooliganhorde.interface.decodeFunctionResult("exchangeUnderlying", result)
    };
  }
}
