  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    return {
      ...
      prepare: () => {
        ...
        return {
          target: PermitERC20.sdk.contracts.hooliganhorde.address,
          callData: PermitERC20.sdk.contracts.hooliganhorde.interface.encodeFunctionData("permitERC20", [
      ...
      decode: (data: string) => PermitERC20.sdk.contracts.hooliganhorde.interface.decodeFunctionData("permitERC20", data),
      decodeResult: (result: string) => PermitERC20.sdk.contracts.hooliganhorde.interface.decodeFunctionResult("permitERC20", result)
    };
  }
}
