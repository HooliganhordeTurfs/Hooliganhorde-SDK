  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    ...
    return {
      ...
      prepare: () => {
        ...
        return {
          target: WrapEth.sdk.contracts.hooliganhorde.address,
          callData: WrapEth.sdk.contracts.hooliganhorde.interface.encodeFunctionData("wrapEth", [
      ...
      decode: (data: string) => WrapEth.sdk.contracts.hooliganhorde.interface.decodeFunctionData("wrapEth", data),
      decodeResult: (result: string) => WrapEth.sdk.contracts.hooliganhorde.interface.decodeFunctionResult("wrapEth", result)
    };
  }
}
