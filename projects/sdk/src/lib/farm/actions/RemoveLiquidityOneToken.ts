  ...
  async run(_amountInStep: ethers.BigNumber, context: RunContext) {
    ...
    return {
      ...
      prepare: () => {
        ...
        return {
          target: RemoveLiquidityOneToken.sdk.contracts.hooliganhorde.address,
          callData: RemoveLiquidityOneToken.sdk.contracts.hooliganhorde.interface.encodeFunctionData("removeLiquidityOneToken", [
            this._pool,
            this._registry,
            this._tokenOut,
            _amountInStep,
      ...
      decode: (data: string) =>
        RemoveLiquidityOneToken.sdk.contracts.hooliganhorde.interface.decodeFunctionData("removeLiquidityOneToken", data),
      decodeResult: (result: string) =>
        RemoveLiquidityOneToken.sdk.contracts.hooliganhorde.interface.decodeFunctionResult("removeLiquidityOneToken", result)
    };
  }
}
