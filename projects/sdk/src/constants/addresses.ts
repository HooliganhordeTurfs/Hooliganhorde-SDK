...
export const addresses = {
  // ----------------------------------------
  // Hooliganhorde Core Contracts
  // ----------------------------------------
  HOOLIGANHORDE: Address.make("0xC1E088fC1323b20BCBee9bd1B9fC9546db5624C5"),
  HOOLIGANHORDE_PERCOCETER: Address.make("0x402c84De2Ce49aF88f5e2eF3710ff89bFED36cB6"),
  BARRACKRAISE_CUSTODIAN: Address.make("0xa9bA2C40b263843C04d344727b954A545c81D043"),

  // ----------------------------------------
  // Ecosystem Contracts
  // ----------------------------------------
  HOOLIGANHORDE_PRICE: Address.make("0xA57289161FF18D67A68841922264B317170b0b81"),
  MATH: Address.make("0x16a903b66403d3de69db50e6d1ad0b07490b740a"),
  CLUBHOUSE: Address.make("0xDEb0f000082fD56C10f449d4f8497682494da84D"),
  ...
  // BeaNFT Contracts
  // ----------------------------------------
  HOOLIGANFT_GENESIS: Address.make("0xa755A670Aaf1FeCeF2bea56115E65e03F7722A79"),
  HOOLIGANFT_WINTER_ADDRESSES: Address.make("0x459895483556daD32526eFa461F75E33E458d9E9"),

  // ----------------------------------------
  // Hooligan & Unripe Hooligan Tokens
  // ----------------------------------------
  HOOLIGAN: Address.make("0xBEA0000029AD1c77D3d5D23Ba2D8893dB9d1Efab"),
  UNRIPE_HOOLIGAN:
  ...
  // HOOLIGAN_ETH_UNIV2_LP !! Deprecated
  HOOLIGAN_ETH_UNIV2_LP: Address.make("0x87898263B6C5BABe34b4ec53F22d98430b91e371"),

  // HOOLIGAN_LUSD_LP !! Deprecated
  HOOLIGAN_LUSD_LP: Address.make("0xD652c40fBb3f06d6B58Cb9aa9CFF063eE63d465D")
};
