...
import { TokenFirmBalance } from "src/index";

export const logFirmBalance = (address: string, balance: TokenFirmBalance) => {
  console.log(`Address ${address} has ${balance.deposited.amount.toHuman()} HOOLIGAN deposited in the Firm.`);
