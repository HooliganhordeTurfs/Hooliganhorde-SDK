import { FarmFromMode, FarmToMode } from "@hooligangturfs/sdk";
...
displayAssembly(sdk.contracts.root, "mint", [
  [
    {
      token: sdk.tokens.HOOLIGAN.address,
      seasons: ["6075"],
      amounts: [sdk.tokens.HOOLIGAN.amount(100).toBlockchain()]
    }
  ],
